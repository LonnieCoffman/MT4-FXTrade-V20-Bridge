            ...
            for fn in os.listdir(static.filepath): # loop through files in directory
                if 'close-' in fn:
                    ...
                    if (side == "buy"):
                    	...
                    	r = positions.PositionClose(static.account_id, instrument, {"longUnits": numUnits})
                    	try:
                            client.request(r)
                    ...
                    if (side == "sell"):
                    	...
                    	r = positions.PositionClose(static.account_id, instrument, {"shortUnits": numUnits})
                    	try:
                            client.request(r)
        ...
        try:
           for fn in os.listdir(static.filepath): # loop through files in directory
               if 'openmarket-' in fn:
                    ...
                    r = orders.OrderCreate(static.account_id,data=mktOrder.data)
...
def update_account():
    ...
    if not is_directory_locked():
        ...
        response = accounts.AccountDetails(static.account_id)
